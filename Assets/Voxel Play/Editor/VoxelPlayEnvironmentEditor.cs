...
namespace VoxelPlay
{
    ...
    public class VoxelPlayEnvironmentEditor : UnityEditor.Editor
    {
        SerializedProperty enableURP, debugLevel;
        ...
        SerializedProperty enableTinting, enableBevel, enableOutline, outlineColor, outlineThreshold, enableCurvature;
...
#endif
        SerializedProperty serverMode, enableColliders, enableTrees, denseTrees, enableVegetation, enableDetailGenerators, enableNavMesh, hideChunksInHierarchy;
        SerializedProperty sun, fogAmount, fogDistance, fogDistanceAuto, fogFallOff, enableClouds;
        ...
        static bool expandQualitySection, expandStatsSection, expandVoxelGenerationSection, expandSkySection, expandInGameSection, expandDefaultsSection;
        ...
        public override void OnInspectorGUI ()
        {
            ...
            if (world.objectReferenceValue != null) {
                ...
                prevBool = renderInEditorDetail.boolValue;
                ...
                if (prevBool != renderInEditorDetail.boolValue) {
                    rebuildWorld = true;
                }
                GUI.enabled = true;
            ...
            if (expandQualitySection) {
                ...
                if (GUILayout.Button (new GUIContent ("Fastest", "Disables all effects to improve performance."))) {
                    ...
                    obscuranceMode.intValue = (int)VoxelPlayEnvironment.ObscuranceMode.Faster;
                ...
                if (obscuranceMode.intValue == (int)VoxelPlayEnvironment.ObscuranceMode.Custom) {
                    EditorGUI.indentLevel++;
                ...
                EditorGUILayout.PropertyField (enableBevel, new GUIContent ("Enable Bevel", "Enables bevel effect by tweaking top face normals. Looks better from a third-person view."));
                ...
                EditorGUILayout.PropertyField (enableFresnel, new GUIContent ("Enable Fresnel", "Enables fresnel effect."));
            ...
            if (expandVoxelGenerationSection) {
                ...
                EditorGUI.BeginChangeCheck ();
                EditorGUILayout.PropertyField (serverMode, new GUIContent ("Server Mode", "Do not render voxels."));
        ...
        {
            if (showHideButton && GUILayout.Button ("Hide Cookie", GUILayout.Width (90))) {
                cookieIndex = -1;
                EditorGUIUtility.ExitGUI ();
            }
            if (GUILayout.Button ("New Cookie", GUILayout.Width (90))) {
                cookieIndex++;
            }

...
public class MySceneLoader : SimpleSingleton<MySceneLoader>
{
    ...
    public static MySceneLoader Create()

    {

        var SceneLoaderPrefab = Resources.Load<MySceneLoader>("SceneLoader");
